$(function () {
    $("#exam_search_button").click(function(){
        ...
        var grand_father_name = $("#exam_result_grand_father_name").val();
        $.ajax({
            url: '/applicants/check_exam',
            data: {id_number: id_number, first_name: first_name, father_name: father_name, grand_father_name: grand_father_name},
